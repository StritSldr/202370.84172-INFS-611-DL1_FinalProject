...
import org.alignment.level.orientation.Orientation;
import org.alignment.level.orientation.OrientationListener;
import org.alignment.level.orientation.OrientationProvider;
import org.alignment.level.util.PreferenceHelper;
import org.alignment.level.view.LevelView;
import org.alignment.level.view.RulerView;
import org.alignment.level.view.VerticalSeekBar;
...
public class Level extends AppCompatActivity implements OrientationListener {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        if (item.getItemId() == R.id.menu_calibrate) {
            ...
            startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("https://github.com/alignment/level")));
